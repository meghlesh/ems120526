    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const taskRes = await axios.get(
          `https:/api-tmsdev-be-ede3ccg8dxd3awbw.southindia-01.azurewebsites.net/manager/emp/task/${user._id}/`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );

       const tasks = taskRes.data.allTasks || [];
       const totalAssignedTasks = taskRes.data.totalTasks || 0;
        ...
        setTotalTeams(teams.length);
        // setTotalTasks(tasks.length);
        setTotalTasks(totalAssignedTasks);
        setEmployees(employeesData);
    ...
    const fetchAvailableEmployees = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          `https:/api-tmsdev-be-ede3ccg8dxd3awbw.southindia-01.azurewebsites.net/manager/${managerId}/available-employees`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
  ...
  return (
    <div className="d-flex align-items-center justify-content-between mb-3">
      <div className="d-flex align-items-center gap-2">
        <img
          src={employee.image || "/myprofile.jpg"}
          alt="Employee"
