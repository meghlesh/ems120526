  ...
  const fetchResignations = async () => {
    try {
      ...
      const response = await axios.get(
        `https:/api-tmsdev-be-ede3ccg8dxd3awbw.southindia-01.azurewebsites.net/resignation`,
        {
          headers: {
      ...
      .map((r) => ({
        ...
        approvedBy: r.approvedBy ? { name: r.approvedBy.name } : null,
      ...
      if (err.response?.status === 401) {
        ...
        alert("Failed to fetch resignation data");
      }
    }
  };
