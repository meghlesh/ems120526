  ...
  useEffect(() => {
    const fetchHolidays = async () => {
      try {
        ...
        const response = await axios.get("https:/api-tmsdev-be-ede3ccg8dxd3awbw.southindia-01.azurewebsites.net/getHolidays", {
  ...
  useEffect(() => {
    const fetchWeeklyOffConfig = async () => {
      try {
        ...
        const response = await axios.get(`https:/api-tmsdev-be-ede3ccg8dxd3awbw.southindia-01.azurewebsites.net/admin/weeklyoff/${currentYear}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
...
const statusBg = {
  ...
  >
    ...
    <option value="Leave">Leaves</option>
      ...
      {/* From */}
      <div className="col-12 col-md-auto d-flex align-items-center ms-2 gap-2">
        <label
          className="fw-bold mb-0"
          style={{
            fontSize: "16px",
